...
import { z } from "zod"
import { Loader2, Check, X, UserPlus, Mail, Lock, User } from "lucide-react"
...
export function SignupForm() {
  ...
  async function onSubmit(data: SignupFormValues) {
    ...
    try {
      ...
      // Aqui você chamaria sua função de cadastro real
      await signupAction({
        name: data.name,
        email: data.email,
    ...
    <div className="grid gap-6">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Seu nome" {...field} className="hover-lift" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="seu@email.com" {...field} className="hover-lift" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="password" placeholder="••••••••" {...field} className="hover-lift" />
                </FormControl>
          ...
          <Button
            type="submit"
            className="w-full bg-koda-blue hover:bg-koda-blue-dark shadow-sm hover:shadow-koda transition-all duration-300"
            disabled={isLoading}
          >
            {isLoading ? (
              <>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Button
          variant="outline"
          type="button"
          className="border-muted-foreground/30 hover:bg-accent/10 hover:text-accent-foreground hover-lift"
        >
