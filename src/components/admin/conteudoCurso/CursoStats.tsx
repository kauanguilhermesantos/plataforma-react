...
export function CursoStats({ stats }: CursoStatsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
      ...
      <Card>
        <CardContent className="p-4 text-center">
          <div className="text-2xl font-bold text-red-600 dark:text-red-400">{stats.cursosArquivados}</div>
          <div className="text-sm text-gray-600 dark:text-gray-400">Arquivados</div>
        </CardContent>
      </Card>
